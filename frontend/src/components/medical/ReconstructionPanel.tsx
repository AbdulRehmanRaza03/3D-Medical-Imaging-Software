    ...
    <div className="space-y-4">
      <div>
        <div className="mb-1 flex items-center justify-between">
          <label className="text-xs font-medium text-slate-500">Bone threshold</label>
          <span className="font-mono text-xs text-slate-600">{threshold} HU</span>
        </div>
        <input
          type="range"
          min={-200}
        ...
        <p className="mt-1.5 text-xs text-slate-400">
          Voxels ≥ threshold form the bone mask.
        </p>
      </div>
